...
urlpatterns = [
    ...
    path('unban/request/close/<int:id>/', views.unban_requests_close, name='close_unban_requests'),
    path('unban/request/approve/<int:id>/', views.unban_requests_approve, name='approve_unban_requests'),
